// Configuración optimizada para entrenamiento rápido con GPU NVIDIA DEDICADA FORZADA
...
void force_nvidia_dedicated_gpu() {
    std::cout << "\n🎯 === FORZANDO GPU NVIDIA DEDICADA ===" << std::endl;
...
int main() {
    ...
    std::cout << "🚀 === INICIANDO ENTRENAMIENTO CON GPU DEDICADA ===\n";
    ...
    if (test_accuracy >= 85.0) {
        ...
        std::cout << "🎯 GPU NVIDIA DEDICADA utilizada exitosamente" << std::endl;
    ...
    std::cout << "   - ✅ Multi-head attention REAL" << std::endl;
    std::cout << "   - ✅ GPU NVIDIA DEDICADA FORZADA" << std::endl;
    std::cout << "   - ✅ Monitoreo de uso GPU en tiempo real" << std::endl;
